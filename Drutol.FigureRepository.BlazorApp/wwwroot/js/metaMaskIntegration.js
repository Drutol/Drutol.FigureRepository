...
export async function listenToChangeEvents() {
    if (hasMetaMask()) {
        ethereum.on("accountsChanged", function (accounts) {
            DotNet.invokeMethodAsync('Drutol.FigureRepository.BlazorApp', 'OnAccountsChangedMetaMask', accounts[0]);
        });

        ethereum.on("chainChanged", function (chainId) {
            DotNet.invokeMethodAsync('Drutol.FigureRepository.BlazorApp', 'OnChainChangedMetaMask', chainId);
        });
    }
}
